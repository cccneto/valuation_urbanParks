...
# DAP's para modelo Log linear na Renda
...
### Dap equação 1
```{r}
dap_eq1_ll <- renda_med - renda_med*(exp(-cf_intercept + cf_idade*idade_med + cf_sexo*sexo_med + cf_escolar*escolar_med + cf_temp*temp_med + cf_infra*infra_med)/cf_lnRendat1)
```

### Dap equação 2
```{r}
dap_eq2_ll <- renda_med - renda_med*(exp(-cf_intercept2 + cf_idade2*idade_med + cf_sexo2*sexo_med + cf_escolar2*escolar_med + cf_temp2*temp_med + cf_infra2*infra_med)/cf_lnRendat2)
